...
def default_scenarios():
    ...
    # 24 
    s = Scenario(map='Town10HD', cam_pos=(-119.07835388183594,117.27436065673828,14.188838958740234), cam_dir=(-39.6103401184082,-6.535345554351807,5.541119776353298e-07), length=4000)
    scenarios.append(s)
    ...
    # 26 
    s = Scenario(map='Town10HD', cam_pos=(64.4912338256836,-64.56993103027344,19.62700080871582), cam_dir=(-41.993492126464844,22.390289306640625,3.675994594232179e-05), length=4000)
    scenarios.append(s)
